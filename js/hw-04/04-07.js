...
for (let i = 0; i < orders.length; i++) {
  ...
  messages.push(composeMessage.call(orders[i], orders.indexOf(orders[i]) + 1))
}
console.log(messages);

['Готовим Burger для solomon@topmail.ua. Ваш заказ 1-й в очереди.', 'Готовим Pizza для artemis@coldmail.net. Ваш заказ 2-й в очереди.', 'Готовим Taco для jacob@mail.com. Ваш заказ 3-й в очереди.']
